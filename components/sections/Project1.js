...
// Objek swiperOptions yang sudah diperbarui
const swiperOptions = {
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="tf-title" data-aos="fade-up" data-aos-duration={800}>
                                <h2 className="title">
                                    Penjalukan e akeh <br className="show-destop" /> bayaran gak kiro kiro
                                </h2>
                            </div>
                        </div>
                        <div className="col-md-12">
                            <div className="project-wrapper">
                                <div className="image-wrapper" data-aos="fade-in" data-aos-duration={1000}>
                                    <div className="swiper-container slider-1">
                                        {/* Gunakan swiperOptions yang sudah diupdate di sini */}
                                        <Swiper {...swiperOptions} className="swiper-wrapper">
                                            <SwiperSlide>
                                                <img src="/assets/images/slider/img_slider_2.png" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <img src="/assets/images/slider/img_slider_3.png" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <img src="/assets/images/slider/img_slider_4.png" alt="" />
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <img src="/assets/images/slider/img_slider_2.png" alt="" />
                                            </SwiperSlide>
